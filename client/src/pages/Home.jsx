...
function Home() {
  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center w-full h-full bg-green-200 gap-12">
        <div className="flex flex-row justify-center items-center w-full gap-12">
          ...
          <h1 className="text-8xl font-black text-white uppercase">
            Nak Makan Mana
          </h1>
        </div>
        <button
        ...
        >
          <h1 className="text-2xl font-bold text-green-200 uppercase">Play</h1>
        </button>
      </div>
    </>
  );
